...
The code below plots the linear models for all the variables. This is to visually show relationships between environmental variables and lichen diversity. The p values were generated from the generalized linear mixed effect models that include site as a fixed effect.
...
This code chunk has each site and its diversity plotted. This doesn't add new information because this was already recorded as gamma diversity in Table 1.
